...
class RegisterForm:
    login: StringValue = StringValue(validator=ValidateString())
    password: StringValue = StringValue(validator=ValidateString())
    email: StringValue = StringValue(validator=ValidateString())
